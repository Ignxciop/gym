    ...
    return (
        <div className="flex items-center justify-center min-h-screen bg-black px-4">
            ...
            >
                ...
                <div>
                    <label className="block mb-2 text-sm font-semibold text-green-600">Confirmar contraseña</label>
                    <input
                        type="password"
                    ...
                    {errors.confirmPassword && (
                        <p className="text-green-600 text-xs mt-1">{errors.confirmPassword.message}</p>
                    )}
                </div>
